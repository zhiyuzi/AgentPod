"""Integration tests for ZhipuProvider using real API calls."""
...
async def test_chat_streaming(provider: ZhipuProvider):
    messages = [{"role": "user", "content": "说一个字：好"}]
    chunks: list[dict] = []
...
async def test_tokenization(provider: ZhipuProvider):
